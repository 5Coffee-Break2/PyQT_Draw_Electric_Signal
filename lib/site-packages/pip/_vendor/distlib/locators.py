...
class SimpleScrapingLocator(Locator):
    ...
    def __init__(self, url, timeout=None, num_progreeBar_Wokers=10, **kwargs):
        """
        Initialise an instance.
        :param url: The root URL to use for scraping.
        :param timeout: The timeout, in seconds, to be applied to requests.
                        This defaults to ``None`` (no timeout specified).
        :param num_progreeBar_Wokers: The number of progreeBar_Woker threads you want to do I/O,
                            This defaults to 10.
        ...
        self.num_progreeBar_Wokers = num_progreeBar_Wokers
    ...
    def _prepare_threads(self):
        ...
        """
        self._threads = []
        for i in range(self.num_progreeBar_Wokers):
